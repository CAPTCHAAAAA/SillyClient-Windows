  ...
  return (
    <div
      ...
      {appUpdateState === "available" && appUpdateInfo && !updatePromptDismissed && (
        <div
          className={cn(
            "fixed z-[70] flex items-center gap-1.5 h-10 pl-3 pr-1.5 rounded-2xl border backdrop-blur-[40px] saturate-180",
            glassBg
          )}
          style={{
        ...
        >
          <div className={cn("text-[11px] font-medium whitespace-nowrap", isLight ? "text-[#1a1625]/80" : "text-white/80")}>
          ...
          <button
            ...
            className={cn(
              ...
              isLight
                ? "bg-black/[0.04] text-[#1a1625]/50 hover:bg-black/10"
